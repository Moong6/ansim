 ...
 * 8차: hasNewAnswer 도착 뱃지 + answerPreview + ANSWERED 상태 표시
 */
          ...
          {items.map((item) => (
            <li key={item.id}>
              ...
              >
                ...
                {/* 답변 미리보기 */}
                {item.answerPreview && (
                  <p className="text-xs text-green-700 line-clamp-1 mb-1 italic">
